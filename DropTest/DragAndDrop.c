...
typedef struct tagMYIDATAOBJECT_VTBL
{
	...
	HRESULT (STDMETHODCALLTYPE *GetData)(PMYIDATAOBJECT pThis, FORMATETC *pFormatEtcIn, STGMEDIUM *pMedium);
	HRESULT (STDMETHODCALLTYPE *GetDataHere)(PMYIDATAOBJECT pThis, FORMATETC *pFormatEtc, STGMEDIUM *pMedium);
	HRESULT (STDMETHODCALLTYPE *QueryGetData)(PMYIDATAOBJECT pThis, FORMATETC *pFormatEtc);
	HRESULT (STDMETHODCALLTYPE *GetCanonicalFormatEtc)(PMYIDATAOBJECT pThis, FORMATETC *pFormatEtcIn, FORMATETC *pFormatEtcOut);
	HRESULT (STDMETHODCALLTYPE *SetData)(PMYIDATAOBJECT pThis, FORMATETC *pFormatEtc, STGMEDIUM *pMedium, BOOL fRelease);
	HRESULT (STDMETHODCALLTYPE *EnumFormatEtc)(PMYIDATAOBJECT pThis, DWORD dwDirection, IEnumFORMATETC **ppenumFormatEtc);
	HRESULT (STDMETHODCALLTYPE *DAdvise)(PMYIDATAOBJECT pThis, FORMATETC *pFormatEtc, DWORD advf, IAdviseSink *pAdvSink, DWORD *pdwConnection);
...
static HRESULT STDMETHODCALLTYPE MYIDROPSOURCE_QueryInterface(PMYIDROPSOURCE pThis, REFIID riid, LPVOID *ppvObject);
...
static HRESULT STDMETHODCALLTYPE MYIDROPSOURCE_QueryContinueDrag(PMYIDROPSOURCE pThis, BOOL fEscapePressed, DWORD grfKeyState);
static HRESULT STDMETHODCALLTYPE MYIDROPSOURCE_GiveFeedback(PMYIDROPSOURCE pThis, DWORD dwEffect);

/* MYIDATAOBJECT functions. */
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_QueryInterface(PMYIDATAOBJECT pThis, REFIID riid, LPVOID *ppvObject);
...
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_GetData(PMYIDATAOBJECT pThis, LPFORMATETC pFormatEtc, LPSTGMEDIUM pMedium);
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_GetDataHere(PMYIDATAOBJECT pThis, LPFORMATETC pFormatEtc, LPSTGMEDIUM pMedium);
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_QueryGetData(PMYIDATAOBJECT pThis, LPFORMATETC pFormatEtc);
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_GetCanonicalFormatEtc(PMYIDATAOBJECT pThis, LPFORMATETC pFormatEtcIn, LPFORMATETC pFormatEtcOut);
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_SetData(PMYIDATAOBJECT pThis, LPFORMATETC pFormatEtc, LPSTGMEDIUM pMedium, BOOL fRelease);
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_EnumFormatEtc(PMYIDATAOBJECT pThis, DWORD dwDirection, LPENUMFORMATETC *ppEnumFormatEtc);
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_DAdvise(PMYIDATAOBJECT pThis, LPFORMATETC pFormatetc, DWORD advf, LPADVISESINK pAdvSink, DWORD *pdwConnection);
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_Dunadvise(PMYIDATAOBJECT pThis, DWORD dwConnection);
static HRESULT STDMETHODCALLTYPE MYIDATAOBJECT_EnumDAdvise(PMYIDATAOBJECT pThis, LPENUMSTATDATA *ppEnumAdvise);

/* MYIDROPTARGET functions. */
static BOOL MYIDROPTARGET_QueryDataObject(PMYIDROPTARGET pDropTarget, IDataObject *pDataObject);
static HRESULT STDMETHODCALLTYPE MYIDROPTARGET_QueryInterface(PMYIDROPTARGET pThis, REFIID riid, LPVOID *ppvObject);
...
static HRESULT STDMETHODCALLTYPE MYIDROPTARGET_DragEnter(PMYIDROPTARGET pThis, IDataObject *pDataObject, DWORD dwKeyState, POINTL pt, DWORD *pdwEffect);
static HRESULT STDMETHODCALLTYPE MYIDROPTARGET_DragOver(PMYIDROPTARGET pThis, DWORD dwKeyState, POINTL pt, DWORD *pdwEffect);
static HRESULT STDMETHODCALLTYPE MYIDROPTARGET_DragLeave(PMYIDROPTARGET pThis);
static HRESULT STDMETHODCALLTYPE MYIDROPTARGET_Drop(PMYIDROPTARGET pThis, IDataObject *pDataObject, DWORD dwKeyState, POINTL pt, DWORD *pdwEffect);
 ...
 */
PMYDROPTARGET MyRegisterDragDrop(HWND hWnd, CLIPFORMAT *pFormat, ULONG lFmt, UINT nMsg, MYDDCALLBACK pDropProc, void *pUserData)
{
	IDropTarget *pTarget;
...
IDataObject *CreateDataObject(CLIPFORMAT *pFormat, HGLOBAL *phData, ULONG lFmt)
{
	...
	if((pRet = HeapAlloc(MYDD_HEAP, 0, sizeof(MYIDATAOBJECT) + lFmt * (sizeof(FORMATETC) + sizeof(HGLOBAL)))) == NULL)
		return NULL;
 ...
 */
IDropTarget *CreateDropTarget(CLIPFORMAT *pFormat, ULONG lFmt, HWND hWnd, UINT nMsg, DWORD (*pDropProc)(CLIPFORMAT cf, HGLOBAL hData, HWND hWnd, DWORD dwKeyState, POINTL pt, void *pUserData), void *pUserData)
{
	PMYIDROPTARGET pRet;
...
static HRESULT STDMETHODCALLTYPE MYIDROPSOURCE_QueryContinueDrag(PMYIDROPSOURCE pThis, BOOL fEscapePressed, DWORD dwKeyState)
{
	if(fEscapePressed)
